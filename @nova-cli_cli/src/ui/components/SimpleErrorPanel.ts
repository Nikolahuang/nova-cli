  ...
  private displayFull(errorInfo: ErrorInfo, context?: any): void {
    ...
    if (errorInfo.suggestion.length > 0) {
      ...
      switch (errorInfo.category) {
        case 'auth':
          console.log('\x1b[36m  â€?nova auth set <provider>\x1b[0m');
          console.log('\x1b[36m  â€?Check environment variables\x1b[0m');
          break;
        case 'config':
          console.log('\x1b[36m  â€?nova config edit\x1b[0m');
          console.log('\x1b[36m  â€?Check ~/.nova/config.yaml\x1b[0m');
          break;
        case 'network':
          console.log('\x1b[36m  â€?Check internet connection\x1b[0m');
          console.log('\x1b[36m  â€?Try nova ollama status\x1b[0m');
          break;
        case 'model':
          console.log('\x1b[36m  â€?nova model list\x1b[0m');
          console.log('\x1b[36m  â€?Check provider configuration\x1b[0m');
          break;
      }
    }
